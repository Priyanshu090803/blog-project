...
//   // Normalize posts data (handle different return types from query)
//   const normalizedPosts = useMemo(() => {
//     if (!posts) return [];

//     // If filtering by category, posts come as { post, category }[]
//     // If not filtering, posts come as Post[] with postsToCategories
//     if (posts.length > 0 && 'post' in posts[0]) {
//       // Group by post ID to combine categories
...
//   // Pagination logic
//   const totalPages = Math.ceil((normalizedPosts?.length || 0) / POSTS_PER_PAGE);
...
//             className={`px-4 py-2 rounded-full text-sm font-medium transition-colors whitespace-nowrap ${!selectedCategory
